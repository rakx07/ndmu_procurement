...
<div class="bg-white p-6 rounded-lg shadow-md">
    <h1 class="text-2xl font-bold mb-4">Rejected Requests</h1>
        ...
        <tbody>
            @forelse ($rejectedRequests as $key => $request)
                <tr class="border">
                    ...
                    <td class="px-4 py-2 border">{{ $request->remarks ?? 'No remarks' }}</td>
                    <td class="px-4 py-2 border text-red-500 font-bold">Rejected</td>
                </tr>
            @empty
                <tr>
