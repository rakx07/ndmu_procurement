...
<head>
    ...
    <title>Comptroller Dashboard</title>
...
<body class="flex bg-gray-100">
    ...
    <nav class="sidebar bg-gray-800 text-white h-screen fixed p-6 flex flex-col justify-between" id="sidebar">
        <ul class="space-y-4">
            <li>
                <a href="{{ route('comptroller.dashboard') }}" class="flex items-center px-3 py-2 hover:bg-gray-700 rounded">
                    <i class="fas fa-home w-6 text-center"></i> <span class="nav-text">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="{{ route('comptroller.pending_approvals') }}" class="flex items-center px-3 py-2 hover:bg-gray-700 rounded">
                    <i class="fas fa-clock w-6 text-center"></i> 
                    <span class="nav-text">Pending Approvals</span>
                </a>
            </li>
            <li>
                <a href="{{ route('comptroller.approved_requests') }}" class="flex items-center px-3 py-2 hover:bg-gray-700 rounded">
                    <i class="fas fa-check-circle w-6 text-center"></i> 
                    <span class="nav-text">Approved Requests</span>
                </a>
            </li>
            <li>
                <a href="{{ route('comptroller.rejected_requests') }}" class="flex items-center px-3 py-2 hover:bg-gray-700 rounded">
