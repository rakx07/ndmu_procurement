...
<body class="flex bg-gray-100">
    ...
    <nav class="sidebar bg-gray-800 text-white h-screen fixed p-6 flex flex-col justify-between" id="sidebar">
        <ul class="space-y-4">
            ...
            <li>
                <a href="{{ route('staff.requests.create') }}" class="flex items-center px-3 py-2 hover:bg-gray-700 rounded">
                    <i class="fas fa-plus-circle w-6 text-center"></i> <span class="nav-text">Create Request</span>
                </a>
            </li>
            <li>
