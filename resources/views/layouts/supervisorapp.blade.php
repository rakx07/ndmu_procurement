...
<body class="flex bg-gray-100">
    ...
    <nav class="sidebar bg-gray-800 text-white h-screen fixed p-6 flex flex-col justify-between" id="sidebar">
        <ul class="space-y-4">
            <li>
                <a href="{{ route('supervisor.dashboard') }}" class="flex items-center px-3 py-2 hover:bg-gray-700 rounded">
                    <i class="fas fa-home w-6 text-center"></i> <span class="nav-text">Dashboard</span>
                </a>
            </li>
            <li>
                <a href="{{ route('supervisor.approve_request', 1) }}" class="flex items-center px-3 py-2 hover:bg-gray-700 rounded">
                    <i class="fas fa-check-circle w-6 text-center"></i> <span class="nav-text">Approve Requests</span>
                </a>
            </li>
            <li>
                <a href="{{ route('supervisor.show', 1) }}" class="flex items-center px-3 py-2 hover:bg-gray-700 rounded">
                    <i class="fas fa-eye w-6 text-center"></i> <span class="nav-text">View Request</span>
                </a>
            </li>
            <li>
